...
function darkMode() {
    ...
    $('.left_sidebar .menu_items .menu_item').css({
        'color': '#fff',
    })

    $('.main_content .main_navbar .dark_mode_icon .bx-sun .table').click(function () {
        $(this).css('display', 'none');
        $('.main_content .main_navbar .dark_mode_icon .bx-moon .table').css('display', 'block');
    });
